...
3. [saf](https://github.com/dspace-unimr/dspyce/tree/main/dspyce/saf) -> The saf packages helps you to create saf packages based on given DSpaceObject objects.
4. [rest](https://github.com/dspace-unimr/dspyce/tree/main/dspyce/rest) -> The rest packages handles the communication with the RestAPI of a given DSpace instance.
